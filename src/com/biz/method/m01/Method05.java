...
public class Method05 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			//int intKor = (int) (Math.random() * (100 - 50 + 1)) + 50; // 50부터 100까지 숫자 만들어내기
			//int intEng = (int) (Math.random() * (100 - 50 + 1)) + 50; // 50부터 100까지 숫자 만들어내기
	...
	public static int makeGrade() {
		int intRND = (int) (Math.random() * (100 - 50 + 1)) + 50; // 50부터 100까지 숫자 만들어내기
		return intRND;
	}
